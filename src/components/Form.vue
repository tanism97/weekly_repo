  ...
  <div class="container mt-5">
    <div class="row">
      <div class="col-md-8 offset-md-2">
        ...
        <form @submit.prevent="submitForm" class="md-3">
          <div class="row mb-3">
        ...
        <br />
        <div class="md-3" v-if="submittedCards.length">
...
const validateReason = (blur) => {
  ...
  } else if (formData.value.reason.length > 15) {
    if (blur) errors.value.reason = 'Reason must be within 15 characters'
  } else {
...
const validateGender = (blur) => {
  if (formData.value.gender.length == 0) {
    if (blur) errors.value.gender = 'Gender cannot be null'
  } else {
